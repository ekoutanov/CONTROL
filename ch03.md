...
2. Risk-based abstraction of requirements, with stakeholder engagement and formal sign-off.
...
* **Experimental or throw-away software**: Software that does not have a significant maintenance component in its lifecycle will not benefit significantly from robust development methodology.
...
Many Agile methods flow in artificially time-boxed iterations, avoiding overly large work allotments. The delivery at the end of each iteration does not necessarily represent a logically complete capability, even if all tickets if the sprint backlog were fully burned down.
...
## Stakeholder
Someone who is materially impacted by the solution. They may be internal to the delivery organisation, internal to the business, or external — for example, a customer.
...
CONTROL builds a strong sense of ownership by enforcing sole custodianship.

## System Testing
The testing of the complete, fully-integrated system — ensuring that both the functional and nonfunctional requirements are met.
