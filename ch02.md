...
* Reduced reliance on stakeholder engagement:
    ...
    + **(+)** Ideally suited to contractual and offsite development (where stakeholders are not collocated with the delivery team).
    + ◦◦◦
...
Agile holds its own in projects where the team is small, highly skilled, and collocated, requirements are extremely uncertain and _legitimately_ ever-changing, and highly engaged stakeholders are available to constantly oversee the product and make corrective inputs.
