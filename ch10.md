...
* **Illusion of objectivity**: An _a priori_ subjective decision method telegraphs its limitations from the outset. Conversely, a process containing some maths and copious evidence of analysis may appear to stakeholders as objective; in reality, it may be a cook up.
...
# The red pill
A police detective is looking to charge a felon with a minor offence. The charge carries a minimal penalty; if it stands up in court, that is. It requires eyewitness testimonies, evidence gathering, and copious amounts of paperwork. And importantly, there is a mountain of more pressing case files that need getting through. There are "proper" murderers and rapists to rid the town of. So, what does the detective do?
...
><sup>7 </sup>Other criteria, such as values and ethical principles, we treat synonymously with principles for convenience. Their differences are not fundamental to our analysis.
...
2. Pick _Y_ with a reduced scope. Once the product gains traction, the complete solution may be delivered later as a follow-up initiative.
3. Do nothing.
