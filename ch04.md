...
The first principle — personal accountability — is often misunderstood, even among seasoned practitioners. Accountability is confused with responsibility; the former is not merely about performing a series of assignments but involves being answerable for the outcomes. Responsibility can be delegated and shared among team members, whereas accountability is personal and must be accepted, not assigned.

Accountability must be clear, uniquely attributable, within the individual's control, and measurable. Accountability also composes hierarchically, where managers delegate responsibilities but retain accountability for overall performance.
