...
Classical methodology focuses predominantly on planning and structure. Methods like Royce's "final" model, Boehm's Spiral, the IID family, and the Unified Process (and its variants) are process-orientated. The latter notably emphasises modelling. They are designed for repeatability and predictability.
